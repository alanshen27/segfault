      ...
      <PageContainer width="wide" className="py-8">
        ...
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="h-24 rounded-xl bg-primary-50 dark:bg-neutral-900 animate-pulse"
            />
          ))}
        </div>
      </PageContainer>
              ...
              <form onSubmit={handleCreatePrize} className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    type="submit"
                    disabled={creating}
                    className="px-4 py-2 rounded-full bg-primary text-white text-sm font-medium hover:bg-primary-hover disabled:opacity-50 transition-colors"
                  >
            ...
            <div className="space-y-2">
              {awards.map((award) => {
                ...
                return (
                  <div
                    key={award.id}
                    className="flex items-center justify-between p-4 rounded-xl border border-primary-200/70 dark:border-neutral-800 bg-card"
                  >
